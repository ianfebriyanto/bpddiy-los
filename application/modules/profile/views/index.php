                ...
                <form action="<?= base_url('profile/updateAct') ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-user" id="PASSWORDlama" name="PASSWORDlama" placeholder="Masukkan Password.">
                            <?= form_error('PASSWORDlama', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="PASSWORD">Password Baru</label>
                            <input type="password" class="form-control form-control-user" id="PASSWORDbaru" name="PASSWORDbaru" placeholder="Masukkan Password Baru.">
                            <?= form_error('PASSWORDbaru', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="PASSWORD">Konfirmasi Password Baru</label>
                            <input type="password" class="form-control form-control-user" id="PASSWORDkonfirm" name="PASSWORDkonfirm" placeholder="Konfiramsi Password Baru.">
                            <?= form_error('PASSWORDkonfirm', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
