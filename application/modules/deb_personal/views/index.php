<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <a href="<?= base_url('pengajuan/personal') ?>"><button type="button" id="createBtn" name="createBtn" class="btn btn-info btn-md btn createBtn mb-2"> <i class="fa fa-plus-square fa-1x"></i> Tambah Debitur Personal</button></a>
    </div>
    <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url('deb_personal/updateAct') ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="NO_DEB">No Deb</label>
                            <input type="text" class="form-control form-control-deb_personal" id="NO_DEB" name="NO_DEBu" placeholder="Masukkan No Deb." value="<?= $data['NO_DEB']; ?>">
                        ...
                        <div class="form-group">
                            <label for="TGL_IDENTITAS">Tgl Identitas</label>
                            <input type="date" class="form-control form-control-deb_personal" id="TGL_IDENTITAS" name="TGL_IDENTITASu" placeholder="Masukkan Tgl Identitas." value="<?= $data['TGL_IDENTITAS']; ?>">
                            <?= form_error('TGL_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_NEGARA">Kd Negara</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_NEGARA" name="KD_NEGARAu" placeholder="Masukkan Kd Negara." value="<?= $data['KD_NEGARA']; ?>">
                            <?= form_error('KD_NEGARAu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="TEMPAT_LAHIR">Tempat Lahir</label>
                            <input type="text" class="form-control form-control-deb_personal" id="TEMPAT_LAHIR" name="TEMPAT_LAHIRu" placeholder="Masukkan Tempat Lahir." value="<?= $data['TEMPAT_LAHIR']; ?>">
                            <?= form_error('TEMPAT_LAHIRu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="TGL_LAHIR">Tgl lahair</label>
                            <input type="date" class="form-control form-control-deb_personal" id="TGL_LAHIR" name="TGL_LAHIRu" placeholder="Masukkan Tgl lahair." value="<?= $data['TGL_LAHIR']; ?>">
                            <?= form_error('TGL_LAHIRu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_KELAMIN">Kd Kelamin</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_KELAMIN" name="KD_KELAMINu" placeholder="Masukkan Kd Kelamin." value="<?= $data['KD_KELAMIN']; ?>">
                            <?= form_error('KD_KELAMINu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_AGAMA">Kd Agama</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_AGAMA" name="KD_AGAMAu" placeholder="Masukkan Kd Agama." value="<?= $data['KD_AGAMA']; ?>">
                            <?= form_error('KD_AGAMAu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KET_AGAMA">Ket Agama</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KET_AGAMA" name="KET_AGAMAu" placeholder="Masukkan Ket Agama." value="<?= $data['KET_AGAMA']; ?>">
                            <?= form_error('KET_AGAMAu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_STS_KAWIN">Kd Sts Kawin</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_STS_KAWIN" name="KD_STS_KAWINu" placeholder="Masukkan Kd Sts Kawin." value="<?= $data['KD_STS_KAWIN']; ?>">
                            <?= form_error('KD_STS_KAWINu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_PENDIDIKAN">Kd Pendidikan</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_PENDIDIKAN" name="KD_PENDIDIKANu" placeholder="Masukkan Kd Pendidikan." value="<?= $data['KD_PENDIDIKAN']; ?>">
                            <?= form_error('KD_PENDIDIKANu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KET_PENDIDIKAN">Ket Pendidikan</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KET_PENDIDIKAN" name="KET_PENDIDIKANu" placeholder="Masukkan Ket Pendidikan." value="<?= $data['KET_PENDIDIKAN']; ?>">
                            <?= form_error('KET_PENDIDIKANu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_PENDUDUK">Kd Penduduk</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_PENDUDUK" name="KD_PENDUDUKu" placeholder="Masukkan Kd Penduduk." value="<?= $data['KD_PENDUDUK']; ?>">
                            <?= form_error('KD_PENDUDUKu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_PEKERJAAN">Kd Pekerjaan</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_PEKERJAAN" name="KD_PEKERJAANu" placeholder="Masukkan Kd Pekerjaan." value="<?= $data['KD_PEKERJAAN']; ?>">
                            <?= form_error('KD_PEKERJAANu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KET_PEKERJAAN">Ket Pekerjaan</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KET_PEKERJAAN" name="KET_PEKERJAANu" placeholder="Masukkan Ket Pekerjaan." value="<?= $data['KET_PEKERJAAN']; ?>">
                            <?= form_error('KET_PEKERJAANu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="ALMT_IDENTITAS">Almt Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="ALMT_IDENTITAS" name="ALMT_IDENTITASu" placeholder="Masukkan Almt Identitas." value="<?= $data['ALMT_IDENTITAS']; ?>">
                            <?= form_error('ALMT_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KELURAHAN_IDENTITAS">Kelurahan Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KELURAHAN_IDENTITAS" name="KELURAHAN_IDENTITASu" placeholder="Masukkan Kelurahan Identitas." value="<?= $data['KELURAHAN_IDENTITAS']; ?>">
                            <?= form_error('KELURAHAN_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KECAMATAN_IDENTITAS">Kecamatan Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KECAMATAN_IDENTITAS" name="KECAMATAN_IDENTITASu" placeholder="Masukkan Kecamatan Identitas." value="<?= $data['KECAMATAN_IDENTITAS']; ?>">
                            <?= form_error('KECAMATAN_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KOTA_IDENTITAS">Kota Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KOTA_IDENTITAS" name="KOTA_IDENTITASu" placeholder="Masukkan Kota Identitas." value="<?= $data['KOTA_IDENTITAS']; ?>">
                            <?= form_error('KOTA_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="PROVINSI_IDENTITAS">Provinsi Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="PROVINSI_IDENTITAS" name="PROVINSI_IDENTITASu" placeholder="Masukkan Provinsi Identitas." value="<?= $data['PROVINSI_IDENTITAS']; ?>">
                            <?= form_error('PROVINSI_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="NO_TELP_IDENTITAS">No Telp Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="NO_TELP_IDENTITAS" name="NO_TELP_IDENTITASu" placeholder="Masukkan No Telp Identitas." value="<?= $data['NO_TELP_IDENTITAS']; ?>">
                            <?= form_error('NO_TELP_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="RT_IDENTITAS">Rt Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="RT_IDENTITAS" name="RT_IDENTITASu" placeholder="Masukkan Rt Identitas." value="<?= $data['RT_IDENTITAS']; ?>">
                            <?= form_error('RT_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="RW_IDENTITAS">Rw Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="RW_IDENTITAS" name="RW_IDENTITASu" placeholder="Masukkan Rw Identitas." value="<?= $data['RW_IDENTITAS']; ?>">
                            <?= form_error('RW_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_POS_IDENTITAS">Kd Pos Identitas</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_POS_IDENTITAS" name="KD_POS_IDENTITASu" placeholder="Masukkan Kd Pos Identitas." value="<?= $data['KD_POS_IDENTITAS']; ?>">
                            <?= form_error('KD_POS_IDENTITASu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="ALMT_TINGGAL">Almt Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="ALMT_TINGGAL" name="ALMT_TINGGALu" placeholder="Masukkan Almt Tinggal." value="<?= $data['ALMT_TINGGAL']; ?>">
                            <?= form_error('ALMT_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KELURAHAN_TINGGAL">Kelurahan Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KELURAHAN_TINGGAL" name="KELURAHAN_TINGGALu" placeholder="Masukkan Kelurahan Tinggal." value="<?= $data['KELURAHAN_TINGGAL']; ?>">
                            <?= form_error('KELURAHAN_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KECAMATAN_TINGGAL">Kecamatan Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KECAMATAN_TINGGAL" name="KECAMATAN_TINGGALu" placeholder="Masukkan Kecamatan Tinggal." value="<?= $data['KECAMATAN_TINGGAL']; ?>">
                            <?= form_error('KECAMATAN_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KOTA_TINGGAL">Kota Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KOTA_TINGGAL" name="KOTA_TINGGALu" placeholder="Masukkan Kota Tinggal." value="<?= $data['KOTA_TINGGAL']; ?>">
                            <?= form_error('KOTA_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="PROVINSI_TINGGAL">Provinsi Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="PROVINSI_TINGGAL" name="PROVINSI_TINGGALu" placeholder="Masukkan Provinsi Tinggal." value="<?= $data['PROVINSI_TINGGAL']; ?>">
                            <?= form_error('PROVINSI_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="RT_TINGGAL">Rt Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="RT_TINGGAL" name="RT_TINGGALu" placeholder="Masukkan Rt Tinggal." value="<?= $data['RT_TINGGAL']; ?>">
                            <?= form_error('RT_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="RW_TINGGAL">Rw Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="RW_TINGGAL" name="RW_TINGGALu" placeholder="Masukkan Rw Tinggal." value="<?= $data['RW_TINGGAL']; ?>">
                            <?= form_error('RW_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_POS_TINGGAL">Kd Pos Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_POS_TINGGAL" name="KD_POS_TINGGALu" placeholder="Masukkan Kd Pos Tinggal." value="<?= $data['KD_POS_TINGGAL']; ?>">
                            <?= form_error('KD_POS_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="NO_TELP_TINGGAL">No Telp Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="NO_TELP_TINGGAL" name="NO_TELP_TINGGALu" placeholder="Masukkan No Telp Tinggal." value="<?= $data['NO_TELP_TINGGAL']; ?>">
                            <?= form_error('NO_TELP_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="TGL_MULAI_TINGGAL">Tgl Mulai Tinggal</label>
                            <input type="date" class="form-control form-control-deb_personal" id="TGL_MULAI_TINGGAL" name="TGL_MULAI_TINGGALu" placeholder="Masukkan Tgl Mulai Tinggal." value="<?= $data['TGL_MULAI_TINGGAL']; ?>">
                            <?= form_error('TGL_MULAI_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>

                        <div class="form-group">
                            <label for="KD_STS_TINGGAL">Kd Sts Tinggal</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_STS_TINGGAL" name="KD_STS_TINGGALu" placeholder="Masukkan Kd Sts Tinggal." value="<?= $data['KD_STS_TINGGAL']; ?>">
                            <?= form_error('KD_STS_TINGGALu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_PENGHASILAN">Kd Penghasilan</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_PENGHASILAN" name="KD_PENGHASILANu" placeholder="Masukkan Kd Penghasilan." value="<?= $data['KD_PENGHASILAN']; ?>">
                            <?= form_error('KD_PENGHASILANu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_PENGHASILAN_LAIN">Kd Penghasilan Lain</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_PENGHASILAN_LAIN" name="KD_PENGHASILAN_LAINu" placeholder="Masukkan Kd Penghasilan Lain." value="<?= $data['KD_PENGHASILAN_LAIN']; ?>">
                            <?= form_error('KD_PENGHASILAN_LAINu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="NAMA_PASUTRI">Nama Pasutri</label>
                            <input type="text" class="form-control form-control-deb_personal" id="NAMA_PASUTRI" name="NAMA_PASUTRIu" placeholder="Masukkan Nama Pasutri." value="<?= $data['NAMA_PASUTRI']; ?>">
                            <?= form_error('NAMA_PASUTRIu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_PEKERJAAN_PASUTRI">Kd Pekerjaan Pasutri</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_PEKERJAAN_PASUTRI" name="KD_PEKERJAAN_PASUTRIu" placeholder="Masukkan Kd Pekerjaan Pasutri." value="<?= $data['KD_PEKERJAAN_PASUTRI']; ?>">
                            <?= form_error('KD_PEKERJAAN_PASUTRIu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KET_PEKERJAAN_PASUTRI">Ket Pekerjaan Pasutri</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KET_PEKERJAAN_PASUTRI" name="KET_PEKERJAAN_PASUTRIu" placeholder="Masukkan Ket Pekerjaan Pasutri." value="<?= $data['KET_PEKERJAAN_PASUTRI']; ?>">
                            <?= form_error('KET_PEKERJAAN_PASUTRIu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="KD_PENGHASILAN_PASUTRI">Kd Penghasilan Pasutri</label>
                            <input type="text" class="form-control form-control-deb_personal" id="KD_PENGHASILAN_PASUTRI" name="KD_PENGHASILAN_PASUTRIu" placeholder="Masukkan Kd Penghasilan Pasutri." value="<?= $data['KD_PENGHASILAN_PASUTRI']; ?>">
                            <?= form_error('KD_PENGHASILAN_PASUTRIu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
                            <label for="NAMA_IBU_KANDUNG">Nama Ibu Kandung</label>
                            <input type="text" class="form-control form-control-deb_personal" id="NAMA_IBU_KANDUNG" name="NAMA_IBU_KANDUNGu" placeholder="Masukkan Nama Ibu Kandung." value="<?= $data['NAMA_IBU_KANDUNG']; ?>">
                            <?= form_error('NAMA_IBU_KANDUNGu', '<small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="form-group">
